...
const DocsSection = () => {
  ...
  return (
    <MainLayout>
    <section className="relative py-40 bg-gradient-to-br from-black via-[#0a0a0a] to-gray-900 text-white overflow-hidden">
      ...
      >
        ...
        >
          ...
          <div className="relative bg-gradient-to-br from-gray-900/90 to-black/90 backdrop-blur-xl border border-white/10 rounded-3xl p-10 overflow-hidden">
            ...
            <div className="flex justify-between items-center max-w-4xl mx-auto gap-12">
